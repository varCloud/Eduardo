...
<!-- Mirrored from codelayers.net/templates/hostlinea/classic-2/portfolio-four.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Mar 2016 15:43:08 GMT -->
<head>
<meta charset="utf-8">
...
<div class="wrapper-boxed">
  <div class="site-wrapper" style="position: relative;">
	      ...
	      <div class="navbar navbar-default yamm">
	        ...
	        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="index.html">Classic 2</a> </li>
              </ul>
            </li>
              ...
              <ul class="dropdown-menu">
	            ...
	            <li class="dropdown"> <a href="portfolio-three.html" class="dropdown-toggle active">Portfolio</a>
              <ul class="dropdown-menu" role="menu">
                ...
                <li> <a class="active" href="portfolio-four.html">Portfolio Columns 4</a> </li>
    ...
    <div class="clearfix"></div>
    <section class="sec-padding section-dark text-center">
      <div class="container">
        <div class="row">
          <h1 class="text-white uppercase font-weight-7">We are host linea</h1>
          <h5 class="text-normal">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. <br/>
            Praesent mattis commodo augue. Aliquam</h5>
          <br/>
          <a href="#" class="btn btn-bgprimary">Get Started</a> </div>
      </div>
    </section>
    <div class="clearfix"></div>
    <!-- end section -->
    ...
    <div class="pagenation-holder">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h4>Portfolio Three Column</h4>
          </div>
          <div class="col-md-6 text-right">
            <div class="pagenation_links"><a href="index.html">Home</a><i> / </i> <a href="index.html">Portfolio</a> <i> / </i> Portfolio Three Column</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div id="filters-container" class="cbp-l-filters-button two three text-right">
            ...
            <div data-filter=".logos" class="cbp-filter-item"> Logos
              <div class="cbp-filter-counter"></div>
            </div>
          </div>
          <div class="demo-full-width">
            <div id="grid-container" class="cbp">
              <div class="cbp-item identity logos"> <a href="images/portfolio/04.jpg" class="cbp-caption cbp-lightbox" data-title="Suspendisse Imperdiet<br>by Codelayers">
                <div class="cbp-caption-defaultWrap"> <img src="images/portfolio/04.jpg" alt=""> </div>
              ...
              <div class="cbp-item web-design"> <a href="images/portfolio/05.jpg" class="cbp-caption cbp-lightbox" data-title="Magna Tempus Urna<br>by Codelayers">
                <div class="cbp-caption-defaultWrap"> <img src="images/portfolio/05.jpg" alt=""> </div>
                <div class="cbp-caption-activeWrap">
                  <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
              ...
              <div class="cbp-item motion identity"> <a href="images/portfolio/06.jpg" class="cbp-caption cbp-lightbox" data-title="World Clock Widget<br>by Codelayers">
                <div class="cbp-caption-defaultWrap"> <img src="images/portfolio/06.jpg" alt=""> </div>
                <div class="cbp-caption-activeWrap">
                  <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
              ...
              <div class="cbp-item identity graphic"> <a href="images/portfolio/07.jpg" class="cbp-caption cbp-lightbox" data-title="Quisque Ornare <br>by Codelayers">
                <div class="cbp-caption-defaultWrap"> <img src="images/portfolio/07.jpg" alt=""> </div>
                <div class="cbp-caption-activeWrap">
                  <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
              ...
              <div class="cbp-item motion logos"> <a href="images/portfolio/08.jpg" class="cbp-caption cbp-lightbox" data-title="Skateshop Website<br>by Codelayers">
                <div class="cbp-caption-defaultWrap"> <img src="images/portfolio/08.jpg" alt=""> </div>
                <div class="cbp-caption-activeWrap">
                  <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
              ...
              <div class="cbp-item web-design"> <a href="images/portfolio/09.jpg" class="cbp-caption cbp-lightbox" data-title="Donec Dapibus Placerat <br>by Codelayers">
                <div class="cbp-caption-defaultWrap"> <img src="images/portfolio/09.jpg" alt=""> </div>
                <div class="cbp-caption-activeWrap">
                  <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
  ...
  <!--end section-->
  <div class="clearfix"></div> <section class="section-primary">
